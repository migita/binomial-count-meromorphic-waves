...
equations with a nonzero Burgers coefficient, and each of them has the
two fronts of Section~\ref{sec:kdvb}, at the rates fixed by that
coefficient. At \(p=3\), with
