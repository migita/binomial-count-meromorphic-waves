...
\(P=D^p\).
Algebraic and \(\ell\)-adic arguments prove it in the range
...
Its travelling waves satisfy \eqref{eq:main} with \(p=2\) and a mixed
operator, which is also the profile equation of KdV--Burgers. At the
