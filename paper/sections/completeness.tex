...
\citet[Theorem~1]{YuanLiQi2014}, with related results for odd \(p\) in
\citet{HuangZhangChenYuan2014,YuanWuChenHuang2014} and a fifth-order
instance in \citet{Dang2023Odd}. For even \(p\) the Laurent recurrence has a resonance at \(n=3p\),
where one coefficient is left free, and the conclusion need not hold
for mixed operators: the
...
monomials, or without the finiteness property (finitely many Laurent
expansions at a pole), are treated by other methods in \citet{Demina2019,Demina2022}.
...
The hypothesis does not cover the mixed operators with \(p\) even,
...
\end{equation}
In this subsection \(b_j\) denotes the coefficients of the even
operator, not those of \eqref{eq:pde}.
