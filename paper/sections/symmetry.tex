...
Thus a purely dispersive equation carries only pulses, and a purely
dissipative equation carries only fronts. The first statement holds in
every even order. The second is proved whenever all pairs are distinct,
and for real waves in every odd order.
