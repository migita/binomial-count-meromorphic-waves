...
flatness that the number of elliptic pairs is conserved.
\end{abstract}
...
\section{Two algebraic arguments from an earlier version}
...
what Section~\ref{sec:prime-powers} uses.
...
their number, counted with multiplicity, does not depend on \(t\). The
paper proves this by a deformation argument. What follows is a second,
algebraic proof. It is Step~4 of the elliptic count in that
